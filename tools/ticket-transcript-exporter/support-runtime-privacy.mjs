...
export function sanitizeSupportPlannerText(value) {
  return String(value)
    ...
    .replace(CM_REFERENCE_PATTERN, '[order reference omitted]')
...
function sanitizeValue(value, key = '') {
  ...
  if (typeof value === 'string') return sanitizeSupportPlannerText(value);
...
export function sanitizeSupportPlannerPayload(value) {
