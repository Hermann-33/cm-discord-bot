...
const manifest = JSON.parse(readFileSync(resolve(root, "release-validation/manifest-b0-v2.json"), "utf8")) as Manifest;
...
if (manifest.fixtureSha256 && manifest.fixtureSha256 !== fixtureSha256) throw new Error("B0 v2 fixture SHA mismatch");
const fixture = JSON.parse(fixtureRaw) as Fixture;
if (fixture.schemaVersion !== 1 || manifest.schemaVersion !== 1 || fixture.rows.length !== manifest.rows) throw new Error("Invalid B0 v2 fixture/manifest");
...
const primaryToAction = new Map<string, string>([
  ...
  ["entity_scoped_clarification", "ask_clarification"],
